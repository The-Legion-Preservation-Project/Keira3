...
export const UNIT_FLAGS: Flag[] = [
  ...
  { bit: 2, name: 'REMOVE_CLIENT_CONTROL' },
  ...
  { bit: 24, name: 'PLAYER_CONTROLLED - under direct client control by a player (possess or vehicle)' },
  {
    bit: 25,
  ...
  { bit: 28, name: 'PREVENT_KNEELING_WHEN_LOOTING' },
  {
    bit: 29,
