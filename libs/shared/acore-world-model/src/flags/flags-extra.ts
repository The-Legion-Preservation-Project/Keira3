...
export const FLAGS_EXTRA: Flag[] = [
  ...
  { bit: 11, name: `USE_OFFHAND_ATTACK - creature will use offhand attacks` },
  { bit: 12, name: `NO_SELL_VENDOR - players can't sell items to this vendor` },
  { bit: 13, name: `CANNOT_ENTER_COMBAT - creature is not allowed to enter combat` },
  ...
  { bit: 22, name: `EVENT_LOOT - Generate special item level on kill creature` },
  { bit: 23, name: `EVENT_NPC - Creature is increase HP by the number of attackers` },
  { bit: 24, name: `VEHICLE_ATTACKABLE_PASSENGERS - creature is vehicle, UNIT_STATE_ONVEHICLE will not add to passengers` },
  { bit: 25, name: `VEH_INSTANT_DESPAWN_PASSENGERS - Instant remove creature passengers` },
  { bit: 26, name: `HP_85_PERC - No damage if HP < 85% for target mob` },
  { bit: 27, name: `UNUSED_27` },
