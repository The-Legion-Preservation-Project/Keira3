...
export const NPC_FLAGS: Flag[] = [
  ...
  { bit: 27, name: 'ARTIFACT_POWER_RESPEC - artifact powers reset' },
  { bit: 27, name: 'TRANSMOGRIFIER' },
  { bit: 28, name: 'VAULTKEEPER - void storage' },
  { bit: 29, name: 'WILD_BATTLE_PET' },
  { bit: 30, name: 'BLACK_MARKET' },
  { bit: 31, name: 'ITEM_UPGRADE_MASTER' },
  { bit: 32, name: 'GARRISON_ARCHITECT' },
  { bit: 33, name: 'STEERING' },
  { bit: 35, name: 'SHIPMENT_CRAFTER' },
  { bit: 36, name: 'GARRISON_MISSION_NPC' },
  { bit: 37, name: 'TRADESKILL_NPC' },
  { bit: 38, name: 'BLACK_MARKET_VIEW' },
];
